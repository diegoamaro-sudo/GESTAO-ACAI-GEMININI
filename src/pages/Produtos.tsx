              ...
              {loading ? (
                ...
                produtos.map((produto) => (
                  <TableRow key={produto.id}>
                    ...
                    <TableCell className="text-right text-destructive">{formatCurrency(produto.custo_unitario)}</TableCell>
                    <TableCell className="text-right text-primary">{formatCurrency(produto.valor_venda)}</TableCell>
                    <TableCell className="text-right text-success">{formatCurrency(produto.lucro)}</TableCell>
